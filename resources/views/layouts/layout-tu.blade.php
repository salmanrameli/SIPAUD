    ...
    <body>
        {{--<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">--}}
            {{--<div class="navbar-header">--}}
                ...
                {{--<a class="navbar-brand" href="{{ route('tu.home') }}">Sistem Informasi Yaa Bunayya</a>--}}
            {{--</div>--}}
            {{--<ul class="nav navbar-top-links navbar-right">--}}
                {{--<li class="dropdown">--}}
                {{--<li>--}}
                    {{--<a href="{{ route('tu.profile') }}"><i class="fa fa-user fa-fw"></i> User Profile</a>--}}
                {{--</li>--}}
                {{--<li>--}}
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('tu.home') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            <li>
                                <a href="{{ route('tu.pengelolaan_siswa') }}"><i class="fa fa-child fa-fw"></i> Pengelolaan Data Siswa</a>
                            </li>
                            <li>
                                <a href="{{ route('tu.pengelolaan_guru') }}"><i class="fa fa-users fa-fw"></i> Pengelolaan Data Guru</a>
                            </li>
                            <li>
                                <a href="{{ route('tu.pengelolaan_tu') }}"><i class="fa fa-wrench fa-fw"></i> Pengelolaan Data Tata Usaha</a>
                            </li>
                            <li>
                                <a href="{{ route('tu.pengelolaan_pelajaran') }}"><i class="fa fa-book fa-fw"></i> Pengelolaan Data Pelajaran</a>
                            </li>
                            <li>
                                <a href="{{ route('tu.siswa.nilai') }}"><i class="fa fa-table fa-fw"></i> Hasil Laporan Penilaian Siswa</a>
                            </li>
