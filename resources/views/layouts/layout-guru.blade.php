        ...
        <div id="wrapper">
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    {{--</a>--}}
                    <li><a style="color:white" href="{{ route('guru.profile') }}"><i style="color:white" class="fa fa-user fa-fw"></i> User Profile</a>
                    </li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('guru.home') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>
                            <li>
                                <a href="{{ route('guru.all_siswa') }}"><i class="fa fa-child fa-fw"></i> Lihat Data Siswa</a>
                            </li>
                            <li>
